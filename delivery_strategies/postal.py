...
class PostalDelivery(AbsDeliveryStrategy):

    percentage_to_increase_by = 1.5
    name = 'Postal service'

    def calculate(self, minimum_delivery_cost: int) -> str:
        new_delivery_cost = calculated_delivery(minimum_delivery_cost, PostalDelivery.percentage_to_increase_by)
